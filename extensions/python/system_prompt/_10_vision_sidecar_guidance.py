...
_D += chr(10) + "- you will NOT see the images directly; ~1500 tok/image stays out of your context. Use raw=true only when Main can see images and truly needs pixels (side-by-side comparison)."
